...
public class ViajesPasadosFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        viajesViewModel.actualizarViajes(ViajesViewModel.Tipo.PASADOS, null, null, getContext());
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        viajesViewModel.getViajes(ViajesViewModel.Tipo.PASADOS, null, null, getContext()).observe(getViewLifecycleOwner(), viajes -> {
